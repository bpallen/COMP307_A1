/* Code for COMP 307 Assignment <s>2005</s> 2013.
 * Name: Ben Allen
 * Usercode: allenbenj
 * ID: 300243905
 * 
 * Modified slightly to use JFileChooser..
 */
...
public class MakeImage implements MouseListener, MouseMotionListener {
	...
	private void resize() {
		...
		for (int r = 0; r < image.length; r++) {
			if (r < rows) for (int c = 0; c < image[r].length; c++)
				if (c < cols) newimage[r][c] = image[r][c];
		}
		image = newimage;
		redraw();
	}
